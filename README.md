About urllib3-future-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/urllib3-future-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/urllib3-future-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add urllib3-future
# for installing globally
pixi global install urllib3-future
```
...
It is possible to list all of the versions of `urllib3-future` available on your platform:
...
```
pixi search urllib3-future --channel conda-forge
```
